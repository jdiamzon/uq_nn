...
NN_savefile::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_1layer["CPU"]["Lin"]).jld2");
...
NN_savefile_2layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_2layer["CPU"]["Lin"]).jld2");

NN_savefile_3layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_3layer["CPU"]["Lin"]).jld2");

NN_savefile_5layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_5layer["CPU"]["Lin"]).jld2");

NN_savefile_7layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_7layer["CUDA"]["Lin"]).jld2");

NN_savefile_10layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_10layer["CUDA"]["Lin"]).jld2");

NN_savefile_12layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_12layer["CUDA"]["Lin"]).jld2");

NN_savefile_18layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/$(file_18layer["CUDA"]["Lin"]).jld2");

NN_savefile_20layer::JLD2.JLDFile = jldopen("../Data/Saved_Models/lin_op/CUDA/20layerFF_leakyreluActFN_1MSamples_3.0e+03Batch_9.0e+02Epochs_1.0e-04LearnRate_1.0e+00RegRate_StepScheduler(true)WithDecayRate8.0e-01.jld2");
...
𝐖_12L, 𝐛_12L = unpack_params(𝚯_12L);
𝐖_12L::Vector{Matrix{Float32}}
𝐛_12L::Vector{Vector{Float32}}
𝐀_12L::Matrix{Float32} = 𝐖_12L[end];

𝐖_18L, 𝐛_18L = unpack_params(𝚯_18L);
𝐖_18L::Vector{Matrix{Float32}}
𝐛_18L::Vector{Vector{Float32}}
𝐀_18L::Matrix{Float32} = 𝐖_18L[end];
